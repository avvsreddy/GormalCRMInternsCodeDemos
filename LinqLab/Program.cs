namespace LanguageEnhancements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Show product id and name

            var result = from p in ProductsDB.GetProducts()
                         select p.Name;
            //select new {PID = p.ProductID, PName = p.Name,CName = p.Catagory.Name };
            ...
            var products = from p in ProductsDB.GetProducts()
